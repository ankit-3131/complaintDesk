    ...
    >
      <div className="flex flex-col justify-between w-3/4 pr-6 overflow-hidden">
        ...
        <div className="flex gap-2">
          ...
          {role === 'Staff' && (
            <div className="flex gap-2">
              {ticket.status != 'In Progress' && (<button onClick={handleEdit} disabled={loadingEdit} className="px-3 py-2 rounded-lg bg-yellow-300/50 text-white disabled:opacity-60">{loadingEdit ? 'Please wait...' : 'Mark in progress'}</button>
              )}
